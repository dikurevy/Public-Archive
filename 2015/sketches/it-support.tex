...
\begin{roles}
\role{A}[Brandt] Systemadministrator
\role{I}[Troels] IT-supporter
\role{X0}[Troels] Instruktør
\role{X1}[Amanda] Bonusinstruktør
\end{roles}

\begin{sketch}

\scene{A og I sidder i hver sin ende af scenen.}

\scene{A sidder ved en skærm og trykker Enter.}
...
\says{A} Øjeblik. \act{taster} Linux mellemrum novonordisk mellemrum 3 punktum
...
\scene{\texttt{Linux novonordisk 3.14.2-amd64 \#1 smp Debian 3.14.15-2 (2014/08-09) x86\_64 GNU/Linux}}
...
\scene{\texttt{Linux novonordisk 3.14.2-amd64 \#1 smp Debian 3.14.15-2 (2014/08-09) x86}}

\says{A} Nej, altså, 'Debian mellemrum 3 punktum 14 punktum 15 streg 2
mellemrum startparantes 2014 streg 08 streg 09 slutparantes mellemrum x 86
\textbf{underscore 64}'.

\scene{\texttt{Linux novonordisk 3.14.2-amd64 \#1 smp Debian 3.14.15-2 (2014/08-09) x86\_64}}
...
\says{I} Nej, jeg sagde åbenparantes \textbf{kolon}.
