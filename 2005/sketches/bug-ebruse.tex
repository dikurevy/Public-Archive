...
\prop{En guitar der må gå i stykker}
\prop{Plastik prinsessekrone}
\prop{Kaj \& Andrea-dukker}
\end{props}
...
\begin{sketch}
  ...
  \says{L} Ok, jeg er også ret træt af at spille guitar til den latterlige løn
  man får her.  \act{kaster guitaren over ryggen}

  \says{K} Jeg vil meget hellere ha' et eventyr
  ...
  \says{L} Rolig nu, rolig nu. Andrea kan da godt være prinsesse, selv om i
  ...
  \says{L} Det er nemlig rigtigt, Kaj.  \act{lalleglad fortællerstemmeleje} Over
  ...
  \says{A} Breakpoint??? Arj altså Kaj, det siger en trold altså ikke, den gør
  ej!

  \says{K} Jeg er heller ikke nogen trold, jeg er en debugger at du ved det.

  \says{A} En debugger? Arj Kaj, der er altså ikke nogen debugger i eventyret,
  der er ej.
  ...
  \act{andreastemme} Årh, årh, og nu kommer den mellemste bug-eBruse
  ...
  \says{K} Nå okæj...  \act{troldestemme} så skrid da med dig din mølædte bunke
  liniestøj

  \says{A} Klippetiklopagtig nu slap jeg væk OG sååå kommer den sidste buk
  ...
  \says{A} Hi hi, ok: \act{BigBB stemme} Det er MIG, den ALLER største bug du
  nogensinde har set.
