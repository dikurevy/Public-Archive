% Oprindeligt filnavn: BrugerViML.tex
...
\begin{roles}
  \role{S}[Mathias] Studerende/forsanger
  \role{A1}[JoJo] Idiotgruppemedlem 1
  \role{A2}[Amira] Idiotgruppemedlem 2
  \role{B1}[JoJo] Klogt gruppemedlem 1
  \role{B2}[Amira] Klogt gruppemedlem 2
