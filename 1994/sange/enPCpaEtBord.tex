...
\version{1.2} % HUSK AT AJOURFORE UDGAVE-NUMMERET!
\flushsingsright
\begin{document}
\twocolumn[
\maketitle

{  \noindent\sl Der er ændret en del i ideen bl.a.\ fordi 16 bit var meget da
  vi prøvede 1.~gang.

  Ideen er et studie forløb, hvor der hvert år skal bruges en ny og
  større PC'er.
...
under vejs, dvs.\ til værre og værre påklædning.}\bigskip
]

\begin{song}

\sings{1} En pc på et bord
...
\sings{8} Men til hvad ska jeg brug'?
        Hele Herligheden nu?
