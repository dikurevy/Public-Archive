...
\begin{roles}
	\role{F}[] Metafortæller
	\role{RH}[] Rødhætte
	\role{U}[] Store stygge ulv
	\role{G1}[] Første lille gris
	\role{G2}[] Anden lille gris
	\role{G3}[] Tredje lille gris
	\role{B}[] Bedste (voice over)
\end{roles}

\begin{props}
	\prop{Hus af strå}[Rekvisitgruppen]
	\prop{Hus af pandekager}[Rekvisitgruppen]
	\prop{Bedstes hus}[Rekvisitgruppen]
	\prop{Skov}[Rekvisitgruppen]
	\prop{Semafor}[Rekvisitgruppen] 2 flag, rødt og grønt
	\prop{3 grisetryner}[Rekvisitgruppen]
	\prop{Blond paryk}[Rekvisitgruppen] til rødhætte
	\prop{Rød hætte}[Rekvisitgruppen]
	\prop{Fyldig bondepigekjole}[Rekvisitgruppen] gerne med underkjole
	\prop{2 ens fletkurve}[Rekvisitgruppen]
	\prop{Rigtige pandekager}[Rekvisitgruppen]
	\prop{Falsk pandekage}[Rekvisitgruppen] Stof eller papir
	\prop{Kyskhedsbælte}[Rekvisitgruppen] Kan være en hængelås-ting som skal være synlig når RH løfter op i kjolen.
\end{props}
...
\says{F} Og ulven pustede og prustede til huset væltede omkuld og spiste den første lille gris.
...
\says{F} Ulven tog nu bedstes kyse og natkjole på, for det var en del af hans snedige plan.
...
\says{F} Den tredje lille gris løb ind i sit hus og løste \emph{alle} døre
